...
export default function AuthForm() {
  ...
  const localizationVariables: I18nVariables = {
    sign_up: {
      ...
      email_input_placeholder: t('auth.supabase.sign_up.email_input_placeholder'),
      password_input_placeholder: t('auth.supabase.sign_up.password_input_placeholder'),
    ...
    sign_in: {
      ...
      email_input_placeholder: t('auth.supabase.sign_in.email_input_placeholder'),
      password_input_placeholder: t('auth.supabase.sign_in.password_input_placeholder'),
    ...
    forgotten_password: {
      ...
      email_input_placeholder: t('auth.supabase.forgotten_password.email_input_placeholder'),
      button_label: t('auth.supabase.forgotten_password.button_label'),
      loading_button_label: t('auth.supabase.forgotten_password.loading_button_label'),
      link_text: t('auth.supabase.forgotten_password.link_text'),
      confirmation_text: t('auth.supabase.forgotten_password.confirmation_text'),
    },
    update_password: {
      password_label: t('auth.supabase.update_password.password_label'),
      password_input_placeholder: t('auth.supabase.update_password.password_input_placeholder'),
      button_label: t('auth.supabase.update_password.button_label'),
      loading_button_label: t('auth.supabase.update_password.loading_button_label'),
