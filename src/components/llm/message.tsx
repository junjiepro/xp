...
import {
  Bot, Check, Loader2, MessageCircleX, Pause, UserRound,
} from "lucide-react"
import {
  HoverCard,
  HoverCardContent,
...
export type Message = { role: string; message: string; event?: XpLLMReciveEvent }

export default function LLMMessage({ msg, abort, children }: { msg: Message; abort: () => void; children: React.ReactNode }) {
  return <div className={cn('mt-2 flex w-full space-x-2', msg.role === 'user' ? 'justify-end' : 'justify-start')}>
