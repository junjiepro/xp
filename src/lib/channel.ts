import { ChannelInterface, ChannelManagerInterface, XpEventHandler, XpEventHandlersEventMap } from '@/types/datas.types';
...
class ChannelManager implements ChannelManagerInterface {
  ...
  on<K extends keyof XpEventHandlersEventMap>(type: K, listener: (ev: XpEventHandlersEventMap[K]) => any, context?: any) {
    this.eventEmitter.on(type, listener, context)
    return this
  }
  off<K extends keyof XpEventHandlersEventMap>(type: K, listener: (ev: XpEventHandlersEventMap[K]) => any, context?: any) {
